        ...
        <div class="col-xl-5 col-lg-12 col-ms-4 d-flex flex-column mx-auto">
            <div class="card card-plain mt-4">
                <?php if(session('mensaje')): ?>
                    ...
                    <div class="alert alert-warning alert-dismissible text-white" role="alert"><span><?php echo e(session('mensaje')); ?></span></div>
                <?php endif; ?>
                    ...
                    <form role="form" method="POST" action="#" id="formulario">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    <input type="number" class="form-control" placeholder="Numero de documento" name="telefono">
                                </div>
                            </div>
                            <div class="col-6">
...
<?php /**PATH C:\xampp\htdocs\Fesc\resources\views/Asp/registro.blade.php ENDPATH**/ ?>